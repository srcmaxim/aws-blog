...
import io.srcmaxim.blog.config.RegisterCustomModuleCustomizer;
...
abstract class AbstractLambdaHandlerTest {
    ...
    {
        new RegisterCustomModuleCustomizer().customize(objectMapper);
    }
